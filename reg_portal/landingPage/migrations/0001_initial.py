    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ead', models.BooleanField(blank=True, default=False, verbose_name='registered for ead')),
                ('lsm', models.BooleanField(blank=True, default=False, verbose_name='registered for lsm')),
